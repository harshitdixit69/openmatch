-- Add offset pagination support to match_profiles RPC

-- Drop the old version of the function first to prevent overloading
...
-- Recreate the function with the new p_offset parameter
...
-- Grant permissions for match_profiles function
