-- Migration: Fix consume_unlock_credit parameter collision by renaming to p_match_id

DROP FUNCTION IF EXISTS public.consume_unlock_credit(uuid);
DROP FUNCTION IF EXISTS public.consume_unlock_credit(match_id uuid);
