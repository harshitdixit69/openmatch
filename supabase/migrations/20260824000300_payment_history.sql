...
-- Table-level privileges. RLS still restricts rows to the owner, but without a SELECT
-- grant the authenticated role gets "permission denied" (42501) before RLS is evaluated.
