...
const styles = StyleSheet.create({
    ...
    headerTitle: { flex: 1, textAlign: 'center', fontSize: 17, fontWeight: '700', color: '#d4a853' },
    searchBarWrap: {
        paddingHorizontal: 16,
        paddingVertical: 10,
    ...
    searchIcon: { fontSize: 18, color: '#d4a853', marginRight: 6 },
    ...
    recentChipText: { color: '#8e8a9e', fontSize: 13, fontWeight: '600' },
    searchInput: { flex: 1, fontSize: 15, color: '#f0ece4' },
    filterContainer: {
        backgroundColor: '#0a0a0c',
        zIndex: 50,
        overflow: 'visible',
    ...
    filterChipActive: { borderColor: '#d4a853', backgroundColor: '#d4a853' },
    ...
    clearChipText: { fontSize: 13, color: '#f87171', fontWeight: '600' },
    resultsMeta: {
    ...
    resultsCount: { fontSize: 12, color: '#8e8a9e' },
    ...
    cardImgPlaceholderText: { color: '#d4a853', fontSize: 18, fontWeight: '700' },
    cardBody: { flex: 1 },
    cardName: { fontSize: 16, fontWeight: '700', color: '#f0ece4', marginBottom: 2 },
    cardMeta: { fontSize: 13, color: '#8e8a9e', marginBottom: 3 },
    cardBio: { fontSize: 13, color: '#a8a4b8', lineHeight: 18 },
    cardBadge: {
        backgroundColor: 'rgba(212,168,83,0.15)',
        borderRadius: 8,
        paddingHorizontal: 8,
    ...
    cardBadgeText: { fontSize: 11, color: '#d4a853', fontWeight: '700' },
    cardRight: {
        alignItems: 'center',
        gap: 6,
        marginLeft: 8,
    ...
    stateTitle: { fontSize: 18, fontWeight: '700', color: '#f0ece4' },
    stateBody: { fontSize: 14, color: '#8e8a9e', textAlign: 'center', maxWidth: 280 },
    stateButton: {
        marginTop: 6,
    ...
    stateButtonText: { color: '#0a0a0c', fontSize: 14, fontWeight: '800' },
});
