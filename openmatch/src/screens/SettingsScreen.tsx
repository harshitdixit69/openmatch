...
const styles = StyleSheet.create({
    ...
    rowLabel: { fontSize: 15, color: '#f0ece4', fontWeight: '600' },
    rowLabelDestructive: { color: '#ef4444' },
    rowSubtitle: { fontSize: 12, color: '#8e8a9e', marginTop: 2, lineHeight: 17 },
    rowChevron: { fontSize: 20, color: '#5a5770', lineHeight: 24 },
    ...
    inlineButtonText: { color: '#0a0a0c', fontSize: 15, fontWeight: '800' },
});
